/**
 * @file DeviceDeleteModal.tsx
 * @description Modal konfirmasi untuk menghapus data alat/device.
 *
 * @module Setting/DeviceManagement/DeviceDeleteModal
 */
      ...
      <div className="relative bg-white rounded-xl shadow-2xl w-full max-w-md mx-4 animate-fadeIn">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-neutral-100">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-lg font-semibold text-neutral-800">Hapus Alat</h2>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="px-6 py-5">
          <p className="text-sm text-neutral-600">Apakah Anda yakin ingin menghapus alat berikut?</p>
          <div className="mt-3 p-3 bg-neutral-50 rounded-lg border border-neutral-200">
            <p className="text-sm font-semibold text-neutral-800">{item.devices_name}</p>
            <p className="text-xs text-neutral-500 mt-0.5">Kode: {item.devices_code}</p>
          </div>
